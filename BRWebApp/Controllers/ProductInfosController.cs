...
namespace BRWebApp.Controllers
{
    ...
    public class ProductInfosController : Controller
    {
        ...
        {
            ViewData["CategoryID"] = new SelectList(_context.CategoryInfos, "CategoryID", "CategoryName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductID,ProductTitle,FileUpload,Description,Price,CategoryID")] ProductInfo productInfo)
        {
            ...
            ViewData["CategoryID"] = new SelectList(_context.CategoryInfos, "CategoryID", "CategoryName", productInfo.CategoryID);
            return View(productInfo);
        }
