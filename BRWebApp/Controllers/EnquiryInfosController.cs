...
namespace BRWebApp.Controllers
{
    ...
    public class EnquiryInfosController : Controller
    {
        ...
        {
            return View(await _context.EnquiryInfos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var enquiryInfo = await _context.EnquiryInfos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var enquiryInfo = await _context.EnquiryInfos.FindAsync(id);
            if (enquiryInfo == null)
            {
                return NotFound();
            }
        ...
        {
            var enquiryInfo = await _context.EnquiryInfos.FindAsync(id);
            _context.EnquiryInfos.Remove(enquiryInfo);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.EnquiryInfos.Any(e => e.EnquiryID == id);
        }
    }
}
