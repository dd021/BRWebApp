...
namespace BRWebApp.Controllers
{
    ...
    public class CategoryInfosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            var categories = from s in _context.CategoryInfos
                           select s;
            switch (sortOrder)
            {
                case "name_desc":
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var categoryInfo = await _context.CategoryInfos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var categoryInfo = await _context.CategoryInfos.FindAsync(id);
            if (categoryInfo == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.CategoryInfos.Any(e => e.CategoryID == id);
        }
    }
}
